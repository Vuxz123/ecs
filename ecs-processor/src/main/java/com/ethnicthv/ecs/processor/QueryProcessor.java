...
public class QueryProcessor extends BaseProcessor {
    ...
    private void generateRunner(TypeElement owner, ExecutableElement method) throws IOException {
        ...
        try (Writer w = file.openWriter()) {
            ...
            w.write("  private final class BuiltQuery implements com.ethnicthv.ecs.core.api.archetype.IQuery { private final Object managedSharedFilter; private final java.util.List<com.ethnicthv.ecs.core.archetype.ArchetypeQuery.UnmanagedFilter> unmanagedSharedFilters; private BuiltQuery(Object managedSharedFilter, java.util.List<com.ethnicthv.ecs.core.archetype.ArchetypeQuery.UnmanagedFilter> unmanagedSharedFilters) { this.managedSharedFilter = managedSharedFilter; this.unmanagedSharedFilters = unmanagedSharedFilters; } @Override public void runQuery() { validateConfig(); if (MODE_PARALLEL) runParallel(this.managedSharedFilter, this.unmanagedSharedFilters); else runSequential(this.managedSharedFilter, this.unmanagedSharedFilters); } }\n");
            // Constructor
            ...
            w.write("  @Override public com.ethnicthv.ecs.core.api.archetype.IQuery build() { Object managedSharedFilter = this.__managedSharedFilter; java.util.List<com.ethnicthv.ecs.core.archetype.ArchetypeQuery.UnmanagedFilter> unmanagedSharedFilters = (this.__unmanagedSharedFilters == null || this.__unmanagedSharedFilters.isEmpty()) ? java.util.List.of() : java.util.List.copyOf(this.__unmanagedSharedFilters); this.__managedSharedFilter = null; if (this.__unmanagedSharedFilters != null) this.__unmanagedSharedFilters.clear(); return new BuiltQuery(managedSharedFilter, unmanagedSharedFilters); }\n");
            ...
            w.write(buildParallelGroupRunner());
            // Drivers
            w.write("  @Override public void runQuery(){ validateConfig(); Object managedSharedFilter = this.__managedSharedFilter; java.util.List<com.ethnicthv.ecs.core.archetype.ArchetypeQuery.UnmanagedFilter> unmanagedSharedFilters = (this.__unmanagedSharedFilters == null || this.__unmanagedSharedFilters.isEmpty()) ? java.util.List.of() : java.util.List.copyOf(this.__unmanagedSharedFilters); this.__managedSharedFilter = null; if (this.__unmanagedSharedFilters != null) this.__unmanagedSharedFilters.clear(); if (MODE_PARALLEL) runParallel(managedSharedFilter, unmanagedSharedFilters); else runSequential(managedSharedFilter, unmanagedSharedFilters); }\n");
...
""";
    ...
    private String buildSharedKeyBuilderBlock() {
        return "  private com.ethnicthv.ecs.core.archetype.SharedValueKey buildQueryKey(com.ethnicthv.ecs.core.archetype.Archetype archetype, Object managedSharedFilter, java.util.List<com.ethnicthv.ecs.core.archetype.ArchetypeQuery.UnmanagedFilter> unmanagedSharedFilters){ int[] managedIdx = null; long[] unmanagedVals = null; boolean any=false; if (managedSharedFilter != null) { int ticket = world.findSharedIndex(managedSharedFilter); if (ticket < 0) return null; int managedCount = archetype.getSharedManagedTypeIds().length; if (managedCount == 0) return null; managedIdx = new int[managedCount]; java.util.Arrays.fill(managedIdx, -1); for (int typeId : archetype.getSharedManagedTypeIds()) { int pos = archetype.getSharedManagedIndex(typeId); if (pos >= 0) { managedIdx[pos] = ticket; any = true; } } } if (unmanagedSharedFilters != null && !unmanagedSharedFilters.isEmpty()) { int unmanagedCount = archetype.getSharedUnmanagedTypeIds().length; if (unmanagedCount == 0) return null; unmanagedVals = new long[unmanagedCount]; java.util.Arrays.fill(unmanagedVals, Long.MIN_VALUE); for (var f : unmanagedSharedFilters) { Integer typeId = world.getComponentTypeId(f.type); if (typeId == null) return null; int pos = archetype.getSharedUnmanagedIndex(typeId); if (pos < 0) return null; unmanagedVals[pos] = f.value; any = true; } } if (!any) return null; return new com.ethnicthv.ecs.core.archetype.SharedValueKey(managedIdx, unmanagedVals); }\n";
    }
    ...
    private String buildParallelGroupRunner() {
        return "  private void runOnGroup_Parallel(com.ethnicthv.ecs.core.archetype.ChunkGroup group, ArchetypePlan plan, com.ethnicthv.ecs.core.components.ComponentManager cm, com.ethnicthv.ecs.core.execution.EcsWorkerPool workerPool){ com.ethnicthv.ecs.core.archetype.ArchetypeChunk[] chunks = group.getChunksSnapshot(); int count = group.chunkCount(); if (count <= 1 || workerPool.parallelism() <= 1) { for (int i = 0; i < count; i++) runOnChunk_Parallel(chunks[i], plan, cm); return; } int batchSize = workerPool.recommendBatchSize(count); workerPool.parallelFor(count, batchSize, (startInclusive, endExclusive) -> { for (int i = startInclusive; i < endExclusive; i++) runOnChunk_Parallel(chunks[i], plan, cm); }); }\n";
    }

    private String buildRunSequentialBlock() {
        return "  private void runSequential(Object managedSharedFilter, java.util.List<com.ethnicthv.ecs.core.archetype.ArchetypeQuery.UnmanagedFilter> unmanagedSharedFilters){ final var cm = world.getComponentManager(); final boolean hasFilter = (managedSharedFilter != null || (unmanagedSharedFilters != null && !unmanagedSharedFilters.isEmpty())); for (com.ethnicthv.ecs.core.archetype.Archetype archetype : world.getAllArchetypes()) { com.ethnicthv.ecs.core.archetype.ComponentMask am = archetype.getMask(); if (!am.containsAll(withMask)) continue; if (!am.containsNone(withoutMask)) continue; if (anyIds.length > 0 && !am.intersects(anyMask)) continue; ArchetypePlan plan = PLAN_CACHE.computeIfAbsent(archetype, a -> buildPlan(a)); if (plan == null) continue; if (hasFilter) { com.ethnicthv.ecs.core.archetype.SharedValueKey qk = buildQueryKey(archetype, managedSharedFilter, unmanagedSharedFilters); if (qk == null) continue; com.ethnicthv.ecs.core.archetype.ChunkGroup g = archetype.getChunkGroup(qk); if (g == null) continue; runOnGroup_Sequential(g, plan, cm); } else { for (com.ethnicthv.ecs.core.archetype.ChunkGroup g : archetype.getAllChunkGroups()) runOnGroup_Sequential(g, plan, cm); } } }\n";
    }

    private String buildRunParallelBlock() {
        return "  private void runParallel(Object managedSharedFilter, java.util.List<com.ethnicthv.ecs.core.archetype.ArchetypeQuery.UnmanagedFilter> unmanagedSharedFilters){ final var cm = world.getComponentManager(); final var workerPool = world.getWorkerPool(); final boolean hasFilter = (managedSharedFilter != null || (unmanagedSharedFilters != null && !unmanagedSharedFilters.isEmpty())); for (com.ethnicthv.ecs.core.archetype.Archetype archetype : world.getAllArchetypes()) { com.ethnicthv.ecs.core.archetype.ComponentMask am = archetype.getMask(); if (!am.containsAll(withMask)) continue; if (!am.containsNone(withoutMask)) continue; if (anyIds.length > 0 && !am.intersects(anyMask)) continue; ArchetypePlan plan = PLAN_CACHE.computeIfAbsent(archetype, a -> buildPlan(a)); if (plan == null) continue; if (hasFilter) { com.ethnicthv.ecs.core.archetype.SharedValueKey qk = buildQueryKey(archetype, managedSharedFilter, unmanagedSharedFilters); if (qk == null) continue; com.ethnicthv.ecs.core.archetype.ChunkGroup g = archetype.getChunkGroup(qk); if (g == null) continue; runOnGroup_Parallel(g, plan, cm, workerPool); } else { for (com.ethnicthv.ecs.core.archetype.ChunkGroup g : archetype.getAllChunkGroups()) runOnGroup_Parallel(g, plan, cm, workerPool); } } }\n";
    }
